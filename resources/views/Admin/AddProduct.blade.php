...
<body class="bg-gray-100">
           ...
           <div class=" rounded-lg dark:border-gray-700">
            ...
            <div class="">
              ...
              <div class="justify-center flex mt-4 ">
                ...
                <form class="ml-10 ms-10 w-96 justify-items-center"  enctype="multipart/form-data" action="products" method="post">
                    @csrf
                    <div class="mb-6">
    ...
    <div class="mb-6">
        ...
        <label for="saleType" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Are product on Promotion?</label>
    ...
    <div class="mb-6">
        ...
        <div class="mb-6">
            <label for="ProductType" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product Sub Category</label>
            <select id="ProductType" name="subCategory" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
         @foreach ($SavedType as $type )
