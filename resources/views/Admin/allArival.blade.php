        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
         ...
         <tbody>
            ...
            @foreach ($data as $all)
                ...
                <td class="px-6 py-4">
                    <img src="{{ asset('uploads/' . $array[0]) }}" alt="{{ $all->productName }}" class="w-16 h-16  object-cover rounded-t-lg" />
         ...
         <td class="px-6 py-4">
                  ...
                  <td class="px-6 py-4">
                    ...
                    <a href="{{ route('arival_edit',['productId' => $all->id]) }}" >
                  ...
                  <td class="px-6 py-4">
                    <a href="{{ route('arival_delete',['productId' => $all->id]) }}" >
